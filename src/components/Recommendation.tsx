    ...
    return (
        <section className="flex min-h-screen w-full flex-col items-center justify-center space-y-20 bg-[#F3F4F6] py-16">
            <header className="flex h-fit w-full flex-col items-center justify-center">
                ...
                <h1 className="text-5xl px-5 md:px-0 md:text-6xl font-semibold ">Early adopters are saying</h1>
            </header>
            <div className="grid w-[70%] grid-cols-1 gap-14 lg:grid-cols-2">
                ...
                <div>
                    <div className="flex h-full w-full flex-col justify-center space-y-5">
                        ...
                        <p className="text-xl font-medium">Elevate your competitive edge with our Competitor Benchmarking feature. Horizon benchmarks your performance against industry leaders, providing actionable insights to outperform your competition.</p>
                        <div className="w-fit">
