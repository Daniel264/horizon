...
export const Pricing = () => {
    return (
        <section className="flex min-h-screen w-full flex-col items-center justify-center gap-20 py-10 bg-[#F3F4F6] bg-[url('/assets/images/pricing-background.svg')] bg-left bg-no-repeat">
